...
| Item | Session | Since |
|---|---|---|
| The panel layout says what the library is missing, a runbook recipe for it, and a draft of the kit mounting designs | `claude/layout-says-whats-missing` | 2026-09-15 |
