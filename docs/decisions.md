...
| D-118 | 2026-09-09 | Master EUR conversion is 113 KES per EUR × landed-cost factor 1.769912 = 200 KES per EUR, back-solved from the NPP-192 Option 1 sheet where every matched catalogue part is priced at exactly EUR × 200. The owner may replace the factor with the real freight-duty-clearing figure. |
